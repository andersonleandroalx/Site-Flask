# routes, links e paginas

from flask import render_template, redirect, url_for, flash, request
from projetoflask.forms import FormLogin, FormCriarConta, FormEditarPerfil, FormCriarPost
from projetoflask import app, database, bcrypt
from projetoflask.models import Usuario, Post
# na ordem -- importa recurso para logar usuario, para deslogar
# usuario e para saber qual usuario está logado no momento, f
...
@login_required
def usuarios():
    lista_usuarios = Usuario.query.all() # puxa todos os usuarios do banco
...
def salvar_imagem(imagem):
    ...
    # mudar o campo foto perfil para o novo nome da imagem
    ...
    # salvar imagem reduzida e renomeada
